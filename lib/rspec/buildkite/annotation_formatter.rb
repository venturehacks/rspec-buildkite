...
module RSpec
  module Buildkite
    ...
    class AnnotationFormatter
      Core::Formatters.register self, :example_failed
      ...
      def thread
        while (notification = @queue.pop)
          ...
          run_agent(notification)
        end
      rescue StandardError
        warn 'ERROR: Warning: Couldn\'t create Buildkite annotations:'
        warn '  ' + $!.to_s +  '    ' + $!.backtrace.join("\n    ")
      end
